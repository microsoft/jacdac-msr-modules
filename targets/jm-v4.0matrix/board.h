...
#define PIN_DISPLAY_COLS PA_4, PA_5, PA_6, PA_9, PA_10
#define PIN_DISPLAY_ROWS PA_7, PA_0, PA_1, PA_2, PA_3

#define NUM_DISPLAY_ROWS 5
#define NUM_DISPLAY_COLS 5
// #define DISP_USE_TIMER 1
#define DISP_LIGHT_SENSE 0

#define SYSTIM_ON_TIM14 1