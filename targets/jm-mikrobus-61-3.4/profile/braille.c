...
#define RESET           0x8000
#define ROW_0_LS_ON     0x4209
#define COL_0_HS_ON     0x0081
#define COL_0_HS_ON_P2  0xC001

#define ROW_0_LS_OFF    0x4201
#define COL_0_HS_OFF    0x0083
#define COL_0_HS_OFF_P2  0x8001
...
uint16_t col0OnP2 = COL_0_HS_ON_P2;

uint16_t row0Dis = ROW_0_LS_OFF;
uint16_t col0Off = COL_0_HS_OFF;
uint16_t col0OffP2 = COL_0_HS_OFF_P2;
